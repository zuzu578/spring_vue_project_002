...
export default{
  ...
  mounted(){
  window.Kakao.init('78fa920aa5f6d2b28e1e1ad5c6b1594a')
  },
  name:"LoginKakao",
...
console.log(self);
    ...
    if(tokens != null){
      ...
      return false;
      // token 이 null 이 아닌경우 해당 유저의 데이터를 가져옴 . 
    ...
    success: function (response) {
      ...
      window.Kakao.API.request({
        ...
        success: async function (response) {
          ...
          //const refreshTokens = response.data.access_token;
          //console.log("get RefreshTokens ======> "+refreshTokens);
          console.log("tokenNumber ====================>" + tokenNumber );

          //const data2 = this.useerData.refresh_token.value;
          //console.log("Data2====>" + data2);
          //console.log("gender 1231231312====> "+ nickname);
          // 성공 하고 server 쪽으로 해당 데이터 전달 
          console.log(response);
